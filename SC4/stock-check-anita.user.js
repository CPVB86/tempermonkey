...
(() => {
  ...
  if (ON_TOOL) {
    ...
    const mounted = Core.mountSupplierButton({
      id: 'stock-check-anita-btn',
      text: 'Controleer Anita',
      right: 250,
      top: 8,
    ...
    mounted.btn.setAttribute('aria-label', 'Controleer voorraad bij Anita of Rosa Faia');
    mounted.btn.title = 'Controleer voorraad bij Anita of Rosa Faia';
  }
